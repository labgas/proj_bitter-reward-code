%% bit_rew_secondlevel_m2_s5_prep_3_calc_univariate_contrasts.m
%
%
% *USAGE*
%
...
if ~exist('DAT','var')
    ...
    try
        ...
        bit_rew_secondlevel_m2_s2_prep_1_set_conditions_contrasts;
...
if ~exist('DATA_OBJ','var')
    ...
    try
        ...
        bit_rew_secondlevel_m2_s4_prep_2_load_image_data_and_save;
