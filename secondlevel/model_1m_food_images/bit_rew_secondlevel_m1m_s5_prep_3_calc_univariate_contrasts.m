%% bit_rew_secondlevel_m1m_s5_prep_3_calc_univariate_contrasts.m
%
%
% *USAGE*
%
...
if ~exist('DAT','var')
    ...
    try
        ...
        bit_rew_secondlevel_m1m_s2_prep_1_set_conditions_contrasts;
        bit_rew_secondlevel_m1m_s3_prep_1b_prep_behavioral_data;
...
if ~exist('DATA_OBJ','var')
    ...
    try
        ...
        bit_rew_secondlevel_m1m_s4_prep_2_load_image_data_and_save;
